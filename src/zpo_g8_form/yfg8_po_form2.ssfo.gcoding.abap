...
*==================== PLANT ======================
PERFORM get_plant_name   USING im_po_head-werks CHANGING gd_plant_name.
PERFORM get_plant_street USING im_po_head-werks CHANGING gd_plant_street.
PERFORM get_plant_city   USING im_po_head-werks CHANGING gd_plant_city.
PERFORM get_plant_phone  USING im_po_head-werks CHANGING gd_plant_phone.
PERFORM get_plant_fax    USING im_po_head-werks CHANGING gd_plant_fax.
