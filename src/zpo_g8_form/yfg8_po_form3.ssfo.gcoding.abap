...
PERFORM get_vendor_email USING im_po_head-lifnr CHANGING gd_vendor_email.
PERFORM get_vendor_postal USING im_po_head-lifnr CHANGING gd_vendor_postal.

PERFORM get_vendor_tax_code USING im_po_head-lifnr CHANGING gd_tax_code.
